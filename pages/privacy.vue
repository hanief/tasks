<template>
  <div>
    ...
    <ul>
      ...
      <li>
        <p><strong>Website</strong> refers to Multitask, accessible from <a
            href="https://multita.sk" rel="external nofollow noopener"
            target="_blank">https://multita.sk</a></p>
      </li>
      <li>
    ...
    <p>If You decide to register through or otherwise grant us access to a
      ...
      Your
      name, Your email address, Your activities or Your contact list associated
      with
      that account.</p>
    ...
    <p>You may update, amend, or delete Your information at any time by signing in
  ...
  <ul>
    <li>By email: task@multita.sk</li>
  </ul>
</div></template>